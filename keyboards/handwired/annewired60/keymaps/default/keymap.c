...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_L1] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                          KC_RALT, LT(_L2, KC_LEFT), RGUI_T(KC_DOWN), RCTL_T(KC_RIGHT)
  ),
  [_L2] = LAYOUT_60_ansi( /* Base */
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLD, KC_VOLU,   KC_DEL,   KC_TRNS,
